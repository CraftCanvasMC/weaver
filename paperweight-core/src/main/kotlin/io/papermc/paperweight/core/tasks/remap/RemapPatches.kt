    ...
    fun run() {
        ...
        PatchSourceRemapWorker(
            ...
            for (patch in patchesToRemap) {
                ...
                println("===========================")
                patchApplier.applyPatch(patch) // Apply patch on Mojang+Parchment mappings
                ...
                patchApplier.checkoutOld() // Normal checkout back to Mojang+Parchment mappings branch
                println("===========================")
