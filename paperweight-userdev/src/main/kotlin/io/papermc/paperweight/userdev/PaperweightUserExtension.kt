...
abstract class PaperweightUserExtension(
    ...
    /**
     * Whether to inject the Canvas maven repositories for use by the dev bundle configuration.
     *
     * True by default to allow easily resolving Canvas development bundles.
     */
    val injectCanvasRepositories: Property<Boolean> = objects.property<Boolean>().convention(true)
